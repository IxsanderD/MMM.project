...
sigma_max=0.83279*0.45
kappa_max=3.221*0.95

solver_Yee=Yee(L,Nx,Ny,Nt,dt,N_PML,PML=True,m=4,sigma_max=sigma_max,kappa_max=kappa_max)
...
# solver_Yee.update_loop()
# solver_Yee.show_recorder()
# solver_Yee.analytical_solution(plot_all=False,frequency_limit=2*Wc)
...
solver_FCI.analytical_sol(p_all=False,f_lim=2*Wc)
